...
<head>
  ...
  <title>Laporan Pengaduan | Pengaduan Masyarakat</title>
    ...
    <div class="row">
      <div class="col-12">
        <h4>
          ...
          @endphp
          <i class="fas fa-globe"></i> Laporan Pengaduan
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td>{{$p->status == '0' ? 'Terkirim' : $p->status}}</td>
                <td>{{$p->isi_laporan}}</td>
                <td>{{$p->tanggapan == '' ? '-' : $p->tanggapan}}</td>
                <td>{{$p->nama_petugas == '' ? '-' : $p->nama_petugas}}</td>
            </tr>
            @endif
            @endforeach
          </tbody>
